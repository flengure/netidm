...
use netidm_proto::constants::{
    ATTR_CONNECTOR_ID, ATTR_CONNECTOR_SECRET, ATTR_DISPLAYNAME, ATTR_NAME,
    ATTR_OAUTH2_AUTHORISATION_ENDPOINT, ATTR_OAUTH2_GROUP_MAPPING, ATTR_OAUTH2_REQUEST_SCOPES,

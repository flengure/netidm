...
// DL38 — authproxy + gitea connector schema attrs
pub const UUID_SCHEMA_ATTR_CONNECTOR_AUTHPROXY_USER_HEADER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002c5");
pub const UUID_SCHEMA_ATTR_CONNECTOR_AUTHPROXY_EMAIL_HEADER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002c6");
pub const UUID_SCHEMA_ATTR_CONNECTOR_AUTHPROXY_GROUPS_HEADER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002c7");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_BASE_URL: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002c8");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_GROUPS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002c9");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_INSECURE_CA: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002ca");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_ROOT_CA: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002cb");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_LOAD_ALL_GROUPS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002cc");
pub const UUID_SCHEMA_ATTR_CONNECTOR_GITEA_USE_LOGIN_AS_ID: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002cd");

// DL39 — keystone connector schema attrs
pub const UUID_SCHEMA_ATTR_CONNECTOR_KEYSTONE_HOST: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002ce");
pub const UUID_SCHEMA_ATTR_CONNECTOR_KEYSTONE_DOMAIN: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002cf");
pub const UUID_SCHEMA_ATTR_CONNECTOR_KEYSTONE_GROUPS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d0");
pub const UUID_SCHEMA_ATTR_CONNECTOR_KEYSTONE_INSECURE_CA: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d1");

// DL40 — atlassian crowd connector schema attrs
pub const UUID_SCHEMA_ATTR_CONNECTOR_CROWD_BASE_URL: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d2");
pub const UUID_SCHEMA_ATTR_CONNECTOR_CROWD_CLIENT_NAME: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d3");
pub const UUID_SCHEMA_ATTR_CONNECTOR_CROWD_CLIENT_SECRET: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d4");
pub const UUID_SCHEMA_ATTR_CONNECTOR_CROWD_GROUPS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff000002d5");

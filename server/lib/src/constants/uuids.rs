...
// DL16 — WireGuard
pub const UUID_SCHEMA_CLASS_WG_TUNNEL: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000229");
pub const UUID_SCHEMA_CLASS_WG_PEER: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022a");
pub const UUID_SCHEMA_ATTR_WG_INTERFACE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022b");
pub const UUID_SCHEMA_ATTR_WG_LISTEN_PORT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022c");
pub const UUID_SCHEMA_ATTR_WG_ADDRESS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022d");
pub const UUID_SCHEMA_ATTR_WG_DNS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022e");
pub const UUID_SCHEMA_ATTR_WG_MTU: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000022f");
pub const UUID_SCHEMA_ATTR_WG_TABLE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000230");
pub const UUID_SCHEMA_ATTR_WG_PRE_UP: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000231");
pub const UUID_SCHEMA_ATTR_WG_POST_UP: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000232");
pub const UUID_SCHEMA_ATTR_WG_PRE_DOWN: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000233");
pub const UUID_SCHEMA_ATTR_WG_POST_DOWN: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000234");
pub const UUID_SCHEMA_ATTR_WG_SAVE_CONFIG: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000235");
pub const UUID_SCHEMA_ATTR_WG_PUBLIC_KEY: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000236");
pub const UUID_SCHEMA_ATTR_WG_ENDPOINT: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000237");
pub const UUID_SCHEMA_ATTR_WG_PUBKEY: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000238");
pub const UUID_SCHEMA_ATTR_WG_ALLOWED_IPS: Uuid =
    uuid!("00000000-0000-0000-0000-ffff00000239");
pub const UUID_SCHEMA_ATTR_WG_PRESHARED_KEY: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000023a");
pub const UUID_SCHEMA_ATTR_WG_PERSISTENT_KEEPALIVE: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000023b");
pub const UUID_SCHEMA_ATTR_WG_TUNNEL_REF: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000023c");
pub const UUID_SCHEMA_ATTR_WG_USER_REF: Uuid =
    uuid!("00000000-0000-0000-0000-ffff0000023d");

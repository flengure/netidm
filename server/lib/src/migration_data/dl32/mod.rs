...
//!   * Twenty-four LDAP-specific config attributes on `EntryClass::Connector`
...
pub fn phase_1_schema_attrs() -> Vec<EntryInitNew> {
    ...
    attrs.push(SCHEMA_ATTR_CONNECTOR_LDAP_HOST_DL32.clone().into());
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_INSECURE_NO_SSL_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_INSECURE_SKIP_VERIFY_DL32
            .clone()
            .into(),
    );
    ...
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USERNAME_PROMPT_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_BASE_DN_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_FILTER_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_USERNAME_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_SCOPE_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_ID_ATTR_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_EMAIL_ATTR_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_NAME_ATTR_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_PREFERRED_USERNAME_ATTR_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_USER_SEARCH_EMAIL_SUFFIX_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_GROUP_SEARCH_BASE_DN_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_GROUP_SEARCH_FILTER_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_GROUP_SEARCH_SCOPE_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_GROUP_SEARCH_USER_MATCHERS_DL32
            .clone()
            .into(),
    );
    attrs.push(
        SCHEMA_ATTR_CONNECTOR_LDAP_GROUP_SEARCH_NAME_ATTR_DL32
            .clone()
            .into(),
    );
    attrs

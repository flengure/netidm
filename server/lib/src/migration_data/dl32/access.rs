//! Access control profiles updated for DL32.
//!
//! The existing `idm_acp_oauth2_client_admin` ACP gains the twenty-four new DL32
//! LDAP-specific attributes in its search / modify / create allowlists.
//!
//! Forked from `IDM_ACP_OAUTH2_CLIENT_ADMIN_DL31`; unchanged except for
...
static FILTER_RECYCLED_OR_TOMBSTONE_DL32: LazyLock<ProtoFilter> = LazyLock::new(|| {
    ProtoFilter::Or(vec![
...
static FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL32: LazyLock<ProtoFilter> =
    LazyLock::new(|| ProtoFilter::AndNot(Box::new(FILTER_RECYCLED_OR_TOMBSTONE_DL32.clone())));

/// DL32 refresh of `idm_acp_oauth2_client_admin`. Forks DL31 and adds the
/// twenty-four LDAP connector config attributes introduced by PR-CONNECTOR-LDAP.
pub(crate) static IDM_ACP_OAUTH2_CLIENT_ADMIN_DL32: LazyLock<BuiltinAcp> =
    LazyLock::new(|| BuiltinAcp {
        ...
        target: BuiltinAcpTarget::Filter(ProtoFilter::And(vec![
            ...
            FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL32.clone(),
        ])),
        search_attrs: vec![
            Attribute::Class,
            Attribute::Uuid,

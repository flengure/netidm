...
pub static SCHEMA_ATTR_DOMAIN_DISPLAY_NAME: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        ...
        description: "The user-facing display name of the Netidm domain".to_string(),
        indexed: true,
        syntax: SyntaxType::Utf8String,
        ..Default::default()
    });
...
pub static SCHEMA_ATTR_SYNC_YIELD_AUTHORITY: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        ...
        description:
            "A set of attributes that have their authority yielded to Netidm in a sync agreement"
                .to_string(),
        multivalue: true,
        syntax: SyntaxType::Utf8StringInsensitive,
        ..Default::default()
...
pub static SCHEMA_CLASS_KEY_PROVIDER_INTERNAL_DL6: LazyLock<SchemaClass> =
    LazyLock::new(|| SchemaClass {
        ...
        description: "The Netidm internal cryptographic key provider".to_string(),
        ..Default::default()
    });

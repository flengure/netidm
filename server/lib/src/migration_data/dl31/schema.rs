...
use crate::constants::{
    ...
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_DOMAIN_HINT,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_EMAIL_TO_LOWERCASE,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GRAPH_URL,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUPS,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUP_NAME_FORMAT,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_ONLY_SECURITY_GROUPS,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PREFERRED_USERNAME_FIELD,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PROMPT_TYPE,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_SCOPES,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_TENANT,
    UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_USE_GROUPS_AS_WHITELIST,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_TENANT_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_TENANT,
        name: Attribute::OAuth2ClientMicrosoftTenant,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_ONLY_SECURITY_GROUPS_DL31: LazyLock<
    SchemaAttribute,
> = LazyLock::new(|| SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_ONLY_SECURITY_GROUPS,
    name: Attribute::OAuth2ClientMicrosoftOnlySecurityGroups,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUPS_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUPS,
        name: Attribute::OAuth2ClientMicrosoftGroups,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUP_NAME_FORMAT_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GROUP_NAME_FORMAT,
        name: Attribute::OAuth2ClientMicrosoftGroupNameFormat,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_USE_GROUPS_AS_WHITELIST_DL31: LazyLock<
    SchemaAttribute,
> = LazyLock::new(|| SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_USE_GROUPS_AS_WHITELIST,
    name: Attribute::OAuth2ClientMicrosoftUseGroupsAsWhitelist,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_EMAIL_TO_LOWERCASE_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_EMAIL_TO_LOWERCASE,
        name: Attribute::OAuth2ClientMicrosoftEmailToLowercase,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_API_URL_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_API_URL,
        name: Attribute::OAuth2ClientMicrosoftApiUrl,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GRAPH_URL_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_GRAPH_URL,
        name: Attribute::OAuth2ClientMicrosoftGraphUrl,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PROMPT_TYPE_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PROMPT_TYPE,
        name: Attribute::OAuth2ClientMicrosoftPromptType,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_DOMAIN_HINT_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_DOMAIN_HINT,
        name: Attribute::OAuth2ClientMicrosoftDomainHint,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_SCOPES_DL31: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_SCOPES,
        name: Attribute::OAuth2ClientMicrosoftScopes,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PREFERRED_USERNAME_FIELD_DL31: LazyLock<
    SchemaAttribute,
> = LazyLock::new(|| SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_PREFERRED_USERNAME_FIELD,
    name: Attribute::OAuth2ClientMicrosoftPreferredUsernameField,
...
pub static SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_ALLOW_JIT_PROVISIONING_DL31: LazyLock<
    SchemaAttribute,
> = LazyLock::new(|| SchemaAttribute {
    uuid: UUID_SCHEMA_ATTR_OAUTH2_CLIENT_MICROSOFT_ALLOW_JIT_PROVISIONING,
    name: Attribute::OAuth2ClientMicrosoftAllowJitProvisioning,

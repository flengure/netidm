//! Access control profiles updated for DL34.
//!
//! The existing `idm_acp_oauth2_client_admin` ACP gains the four new DL34
//! OpenShift connector attributes in its search / modify / create allowlists.
//!
//! Forked from `IDM_ACP_OAUTH2_CLIENT_ADMIN_DL32`; unchanged except for
...
static FILTER_RECYCLED_OR_TOMBSTONE_DL34: LazyLock<ProtoFilter> = LazyLock::new(|| {
    ProtoFilter::Or(vec![
...
static FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL34: LazyLock<ProtoFilter> =
    LazyLock::new(|| ProtoFilter::AndNot(Box::new(FILTER_RECYCLED_OR_TOMBSTONE_DL34.clone())));

/// DL34 refresh of `idm_acp_oauth2_client_admin`. Forks DL32 and adds the
/// four OpenShift connector config attributes introduced by PR-CONNECTOR-OPENSHIFT.
pub(crate) static IDM_ACP_OAUTH2_CLIENT_ADMIN_DL34: LazyLock<BuiltinAcp> =
    LazyLock::new(|| BuiltinAcp {
        ...
        target: BuiltinAcpTarget::Filter(ProtoFilter::And(vec![
            ...
            FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL34.clone(),
        ])),
        search_attrs: vec![
            Attribute::Class,
            Attribute::Uuid,

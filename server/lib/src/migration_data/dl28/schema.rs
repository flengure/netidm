...
use crate::constants::{
    ...
    UUID_SCHEMA_ATTR_CONNECTOR_GITHUB_HOST, UUID_SCHEMA_ATTR_CONNECTOR_GITHUB_LOAD_ALL_GROUPS,
    UUID_SCHEMA_ATTR_CONNECTOR_GITHUB_ORG_FILTER,
    UUID_SCHEMA_ATTR_CONNECTOR_GITHUB_PREFERRED_EMAIL_DOMAIN,
    UUID_SCHEMA_ATTR_CONNECTOR_GITHUB_TEAM_NAME_FIELD, UUID_SCHEMA_ATTR_CONNECTOR_PROVIDER_KIND,

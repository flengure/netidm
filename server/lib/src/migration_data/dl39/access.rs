//! Access control profiles updated for DL39.
//!
//! `idm_acp_connector_admin` is refreshed to include the 4 new DL39 attrs
//! (keystone) in all allowlists. Forked from DL38.
...
static FILTER_RECYCLED_OR_TOMBSTONE_DL39: LazyLock<ProtoFilter> = LazyLock::new(|| {
    ProtoFilter::Or(vec![
...
static FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL39: LazyLock<ProtoFilter> =
    LazyLock::new(|| ProtoFilter::AndNot(Box::new(FILTER_RECYCLED_OR_TOMBSTONE_DL39.clone())));

/// DL39 refresh of `idm_acp_connector_admin`. Forks DL38 and adds
/// keystone attrs to all allowlists.
pub(crate) static IDM_ACP_OAUTH2_CLIENT_ADMIN_DL39: LazyLock<BuiltinAcp> =
    LazyLock::new(|| BuiltinAcp {
        ...
        target: BuiltinAcpTarget::Filter(ProtoFilter::And(vec![
            ...
            FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL39.clone(),
        ])),
        search_attrs: vec![
            Attribute::Class,
            Attribute::Uuid,

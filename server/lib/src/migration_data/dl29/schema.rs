...
//! All are optional with documented defaults so pre-DL29 `Connector` entries
//! decode unchanged. The discriminator `ConnectorProviderKind` was already
...
use crate::constants::{
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_ALLOWED_GROUPS,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_ENABLE_GROUPS,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GET_USER_INFO,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_KEY,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_PREFIX,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_SUFFIX,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_OVERRIDE_CLAIM_MAPPING,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_SKIP_EMAIL_VERIFIED,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_USER_ID_KEY,
    UUID_SCHEMA_ATTR_CONNECTOR_OIDC_USER_NAME_KEY, UUID_SCHEMA_CLASS_CONNECTOR,
};
use crate::prelude::*;
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_ENABLE_GROUPS_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_ENABLE_GROUPS,
        name: Attribute::ConnectorOidcEnableGroups,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_KEY_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_KEY,
        name: Attribute::ConnectorOidcGroupsKey,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_SKIP_EMAIL_VERIFIED_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_SKIP_EMAIL_VERIFIED,
        name: Attribute::ConnectorOidcSkipEmailVerified,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_ALLOWED_GROUPS_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_ALLOWED_GROUPS,
        name: Attribute::ConnectorOidcAllowedGroups,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_GET_USER_INFO_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GET_USER_INFO,
        name: Attribute::ConnectorOidcGetUserInfo,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_USER_ID_KEY_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_USER_ID_KEY,
        name: Attribute::ConnectorOidcUserIdKey,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_USER_NAME_KEY_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_USER_NAME_KEY,
        name: Attribute::ConnectorOidcUserNameKey,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_OVERRIDE_CLAIM_MAPPING_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_OVERRIDE_CLAIM_MAPPING,
        name: Attribute::ConnectorOidcOverrideClaimMapping,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_PREFIX_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_PREFIX,
        name: Attribute::ConnectorOidcGroupsPrefix,
...
pub static SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_SUFFIX_DL29: LazyLock<SchemaAttribute> =
    LazyLock::new(|| SchemaAttribute {
        uuid: UUID_SCHEMA_ATTR_CONNECTOR_OIDC_GROUPS_SUFFIX,
        name: Attribute::ConnectorOidcGroupsSuffix,

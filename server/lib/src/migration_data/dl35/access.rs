//! Access control profiles updated for DL35.
//!
//! The existing `idm_acp_oauth2_client_admin` ACP gains the five new DL35
//! GitLab connector attributes in its search / modify / create allowlists.
//!
//! Forked from `IDM_ACP_OAUTH2_CLIENT_ADMIN_DL34`; unchanged except for
...
static FILTER_RECYCLED_OR_TOMBSTONE_DL35: LazyLock<ProtoFilter> = LazyLock::new(|| {
    ProtoFilter::Or(vec![
...
static FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL35: LazyLock<ProtoFilter> =
    LazyLock::new(|| ProtoFilter::AndNot(Box::new(FILTER_RECYCLED_OR_TOMBSTONE_DL35.clone())));

/// DL35 refresh of `idm_acp_oauth2_client_admin`. Forks DL34 and adds the
/// five GitLab connector config attributes introduced by PR-CONNECTOR-GITLAB.
pub(crate) static IDM_ACP_OAUTH2_CLIENT_ADMIN_DL35: LazyLock<BuiltinAcp> =
    LazyLock::new(|| BuiltinAcp {
        ...
        target: BuiltinAcpTarget::Filter(ProtoFilter::And(vec![
            ...
            FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL35.clone(),
        ])),
        search_attrs: vec![
            Attribute::Class,
            Attribute::Uuid,

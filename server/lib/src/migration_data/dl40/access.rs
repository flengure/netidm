//! Access control profiles updated for DL40.
//!
//! `idm_acp_connector_admin` is refreshed to include the 4 new DL40 attrs
//! (crowd) in all allowlists. Forked from DL39.
...
static FILTER_RECYCLED_OR_TOMBSTONE_DL40: LazyLock<ProtoFilter> = LazyLock::new(|| {
    ProtoFilter::Or(vec![
...
static FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL40: LazyLock<ProtoFilter> =
    LazyLock::new(|| ProtoFilter::AndNot(Box::new(FILTER_RECYCLED_OR_TOMBSTONE_DL40.clone())));

/// DL40 refresh of `idm_acp_connector_admin`. Forks DL39 and adds
/// crowd attrs to all allowlists.
pub(crate) static IDM_ACP_OAUTH2_CLIENT_ADMIN_DL40: LazyLock<BuiltinAcp> =
    LazyLock::new(|| BuiltinAcp {
        ...
        target: BuiltinAcpTarget::Filter(ProtoFilter::And(vec![
            ...
            FILTER_ANDNOT_TOMBSTONE_OR_RECYCLED_DL40.clone(),
        ])),
        search_attrs: vec![
            Attribute::Class,
            Attribute::Uuid,

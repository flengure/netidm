...
#[openapi(
    ...
    paths(
        ...
        super::v1_oauth2::connector_list,
        super::v1_oauth2::connector_id_get,
        super::v1_oauth2::connector_post,
        super::v1_oauth2::connector_id_patch,
        super::v1_oauth2::connector_id_delete,
        ...
        super::v1::whoami,
        super::v1::whoami_uat,
        super::v1::self_logout_all,
        super::v1::person_logout_all,
        super::v1::logout_deliveries_list,
        super::v1::logout_deliveries_show,

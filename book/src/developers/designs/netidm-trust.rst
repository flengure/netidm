...
Trust is a process where users and groups of a separate netidm instance may be granted access
...
* Invite Ext - On the fence - cool idea, but not sure how it fits into netidm with trusts.
...
is a very similar scenario to replication. As Netidm plans to implement a push based replication
...
Netidm portal: user@domain_a logs into netidm portal on domain B

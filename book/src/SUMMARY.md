...
- [Service Integrations](integrations/readme.md)
  ...
  - [Upstream Connectors](integrations/connectors/index.md)
    - [GitHub](integrations/connectors/github.md)
    - [GitLab](integrations/connectors/gitlab.md)
    - [Google](integrations/connectors/google.md)
    - [Microsoft / Entra ID](integrations/connectors/microsoft.md)
    - [Generic OIDC](integrations/connectors/oidc.md)
    - [LDAP](integrations/connectors/ldap.md)
    - [SAML 2.0](integrations/connectors/saml.md)
    - [Bitbucket Cloud](integrations/connectors/bitbucketcloud.md)
    - [OpenShift](integrations/connectors/openshift.md)
    - [LinkedIn](integrations/connectors/linkedin.md)
    - [Auth Proxy](integrations/connectors/authproxy.md)
    - [Gitea](integrations/connectors/gitea.md)
    - [OpenStack Keystone](integrations/connectors/keystone.md)
    - [Atlassian Crowd](integrations/connectors/atlassiancrowd.md)
  - [Migrating from Dex](integrations/migration_from_dex.md)

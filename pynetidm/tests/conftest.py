"""Shared pytest fixtures for the pynetidm test suite."""

from pathlib import Path

import pytest
from netidm.openapi_codegen import generate_openapi_client
...
PYNETIDM_DIR = Path(__file__).resolve().parents[1]
...
def openapi_codegen_once(
    ...
    generate_openapi_client(
        ...
        output=PYNETIDM_DIR / "netidm_openapi_client",
    )

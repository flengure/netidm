...
pub struct NetidmdCli {
    #[clap(
        env = "NETIDM_LOG_LEVEL",
        global = true,
    ...
    #[clap(
        env = "NETIDM_OTEL_GRPC_URL",
        global = true,
        help = "Specify the OpenTelemetry gRPC URL"
    )]
    pub otel_grpc_url: Option<String>,

    #[clap(env = "NETIDM_DOMAIN", global = true, help = "Specify the domain")]
    pub domain: Option<String>,

    #[clap(env = "NETIDM_ORIGIN", global = true, help = "Specify the origin URL")]
    pub origin: Option<url::Url>,

    #[clap(env = "NETIDM_ROLE", global = true, help = "Specify the server role")]
    ...
    #[clap(
        global = true,
        hide = true,
        env = "NETIDM_TRUST_X_FORWARDED_FOR",
    ...
    #[clap(
        env = "NETIDM_REPLICATION_BINDADDRESS",
        global = true,
    ...
    #[clap(
        env = "NETIDM_REPLICATION_TASK_POLL_INTERVAL",
        global = true,
    ...
    #[clap(
        global = true,
        env = "NETIDM_ONLINE_BACKUP_VERSIONS",
    ...
    #[clap(
        global = true,
        env = "NETIDM_ONLINE_BACKUP_SCHEDULE",
